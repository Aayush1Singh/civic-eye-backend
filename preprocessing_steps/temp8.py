...
doc = fitz.open("./docs/evidence_act.pdf")
...
# contract_act
page = doc[4]
clip = fitz.Rect(50, 60, page.rect.width-50, page.rect.height-70) # Top 100pt is header, bottom 50pt is footer
for page in doc:
    page.set_cropbox(clip)

doc.save("./preprocessed_docs/cropped_evidence_act.pdf")
